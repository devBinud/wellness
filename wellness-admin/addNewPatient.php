...
<div class="row">
  ...
  <div class="col-12 col-xl-8 mb-4 mb-xl-0">
    ...
    <p class="mb-2 text-secondary">Add New Patient</p>
  </div>
  <div class="col-md-12">
    <div class="card">
      <div class="card-body">
        <form class="forms-sample" action="#" method="POST" id="addPatient" enctype="multipart/form-data">
          ...
          <div class="row">
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="date" name="dob" class="form-control" id="dob" placeholder="Choose date of birth">
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="form-group">
                    <label for="age">Age (years) <span class="text-danger"> *</span> </label>
                    <input type="number" name="age" class="form-control" id="age" value="1" max="120"
            ...
            <div class="col-md-4">
              <div class="row">
                <div class="col-md-12">
                  <div class="card" style="border:0.5px solid #d3c9c9">
                    <div class="card-header">
                      <div>
                        <h6 class="card-title text-primary">Patients Picture</h6>
                      </div>
                    </div>
                    <div class="card-body text-center">
                      <div class="mb-2" id="profilePicHolder" style="min-height: 120px;">
                        <img src="./images/faces/avtar.png" width="108" height="110" alt="">
                      </div>
                      <div class="row">
                        <div class="col-md-6 px-1">
                          <input type="hidden" name="profile_pic_text" id="profilePicText">
                          <button type="button" class="btn btn-primary btn-icon-text">
                            <i class="ti-image btn-icon-prepend"></i>Picture
                          </button>
                        </div>
                        <div class="col-md-6 px-1">
                          <input type="file" name="img_file" class="d-none" id="imgFile"
                            accept="image/png, image/jpg, image/jpeg">
                          <button type="button" class="btn btn-danger btn-icon-text">
                            <i class="ti-upload btn-icon-prepend"></i>choose
                          </button>
                        </div>
                      </div>
                    </div>
