...
<div class="row">
  ...
  <div class="col-12 col-xl-12 mb-4 mb-xl-0 d-flex justify-content-between">
    <div class="title">
      <h3 class="font-weight-bold text-primary mb-2" style="font-size:20px;">DOCTOR REPORT</h3>
      <p class="text-secondary">Reports of doctors</p>
    </div>
...
<div class="row">
  <div class="col-xxl-4 col-md-3">
    <div class="card info-card">
      <div class="card-body">
        <h5 class="card-title text-primary">Doctors<span class="span_small"> | Total </span></h5>

        <div class="d-flex align-items-center">
          <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
          </div>
          <div class="p-2 ml-4">
            <h3 class="text-center text-dark">53</h3>
          </div>
        </div>
      </div>
  ...
  <div class="col-xxl-4 col-md-3">
    <div class="card info-card doctor-card">
      <div class="card-body">
        <h5 class="card-title text-primary">Total Patient <span class="span_small">| Today</span></h5>
  ...
  <div class="col-xxl-4 col-md-3">
    <div class="card info-card revenue-card">
      ...
      <div class="card-body">
        <h5 class="card-title text-primary">Patient <span class="span_small">| This Month</span></h5>
  ...
  <div class="col-xxl-4 col-md-3">
    <div class="card info-card">
      ...
      <div class="card-body">
        <h5 class="card-title text-primary">OPD Patient</h5>
...
<div class="row mt-3 d-flex justify-content-between">
  <div class="col-md-12">
    ...
    <div class="card-body table-responsive mt-3">
      <h4 class="mb-3 text-primary">No of Doctors (centerwise)</h4>
...
<div class="row mt-3">
  <div class="col-md-12">
    ...
    <div class="card-body table-responsive">
      <h4 class="mb-3 text-primary">Recent Patients</h4>
