          ...
          <div class="container">
            ...
            <div class="row mt-4">
                      ...
                      <div class="row">
                        <div class="col-md-3">
                          <div class="form-group">
                            ...
                            <input type="text" name="uhid" class="form-control form-control-sm" id="uhid"
                              placeholder="">
                          </div>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                            ...
                            <input type="date" name="reg_date" class="form-control form-control-sm" id="regDate"
                              placeholder="">
                          </div>
                        </div>
                        <div class="col-md-2 m-auto">
                          <div class="form-group m-auto ">
                            <button type="submit" class="btn btn-primary " id="" data-toggle="tooltip"
                              data-placement="top" title="Search Patients"><i class="fa-solid fa-search"></i></button>
                          </div>
                        </div>
                      </div>
                    </form>
              ...
              <div class="col-md-12 add-case-div  mt-2">
                <div class="card">
                  <div class="card-body ">
                    <form class="forms-sample" action="#" method="POST" id="addPatientCase"
