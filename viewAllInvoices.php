      ...
      <div class="col-md-12 table-responsive mt-3">
        <div class="card">
          <div class="row d-flex justify-content-between mt-3">
            <div class="col-md-6">
              <a href="createNewInvoice.php" class="btn btn-primary">Create New Invoice <i class="fa fa-plus ml-2"></i></a>
            ...
            <table class="table table-bordered table-hover text-center">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>000001</td>
                  <td>₹ 12320.00</td>
                  <td><a href="viewInvoice.php"><i class="fa fa-eye text-primary"></i></a></td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">View Bill Details</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <h2 class="text-danger text-center">Bill Details Section </h2>
      </div>
