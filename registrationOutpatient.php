...
<div class="row">
  ...
  <div class="col-12 col-xl-8 mb-4 mb-xl-0">
    ...
    <p class="mb-2 text-secondary">Registration for out-patient</p>
  </div>
    ...
    <div class="card" style="border:1px solid #a4aec4">
      <div class="card-body">
        <form class="forms-sample" action="#" method="POST" id="addPatient" enctype="multipart/form-data">
          ...
          <div class="row">
            <div class="col-md-12">
              <h6 class="text-uppercase mb-3 font-weight-bold">Referred Doctor's Details :</h6>
              <hr>
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="name">Doctor's Name <span class="text-danger"> *</span> </label>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="name">Prescription No <span class="text-danger"> *</span> </label>
                    <input type="text" name="name" class="form-control" id="name" placeholder="Enter Prescription No"
                      required>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control" id="name" placeholder="Enter Hospital Name"
                      required>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control" id="name" placeholder="Enter phone no" required>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <h6 class="text-uppercase mb-3 font-weight-bold">Details of Patient :</h6>
              <hr>
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" name="email" class="form-control" id="email" placeholder="Enter patient's email">
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                ...
                <select name="nationality_id" class="form-control js-example-basic-single" id="nationality" required>
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <select name="state_id" class="form-control js-example-basic-single w-100" id="state" required>
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <select name="district_id" class="form-control js-example-basic-single" id="district" required>
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" name="city" class="form-control" id="city" placeholder="Enter city or village">
              </div>
            </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label for="city">Address Line 1</label>
                  <input type="text" name="city" class="form-control" id="city" placeholder="Address Line 1">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label for="city">Address Line 2</label>
                  <input type="text" name="" class="form-control" id="city" placeholder="Address Line 2">
                </div>
              </div>
          ...
          <hr>
          <h6 class="text-uppercase fw-bold">More Details of Patient :</h6>

          <div class="row mt-4">
            <div class="col-md-4">
              <div class="form-group">
                <label for="attendent">Blood Pressure </label>
                <input type="text" name="" class="form-control" id="" placeholder="Enter Blood Pressure">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" name="" class="form-control" id="attendentPhone" placeholder="Enter the Height">
              </div>
            </div>
