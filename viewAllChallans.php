...
<div class="row">
  ...
  <div class="col-12 col-xl-12 mb-2 mb-xl-0 d-flex justify-content-between">
    <div class="title">
      <h3 class="font-weight-bold text-primary mb-2">VIEW ALL CHALLANS</h3>
      <p class="mb-2 text-secondary">List Of All Challans</p>
    </div>
            ...
            <table class="table table-bordered table-hover text-center">
              ...
              <tbody>
                ...
                <tr>
                  <td>1</td>
                  <td>20 Jun, 2022</td>
                  <td>Inward Challan</td>
                  <td>000001</td>
                  <td>
                  <a class="text-primary" target="_blank" href="viewInwardChallan.php">
                ...
                <tr>
                  <td>2</td>
                  <td>22 Juy, 2022</td>
                  <td>Outward Challan</td>
                  <td>000002</td>
                  <td>
                    <a class="text-primary" target="_blank" href="viewOutwardChallan.php">
                      <i class="fa fa-eye" aria-hidden="true"></i>
                    </a>
                  </td>
                </tr>
